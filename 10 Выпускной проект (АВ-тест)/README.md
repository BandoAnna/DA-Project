...
1. Импорт данных первичный осмотр
2. Оценка корректноси проведения теста (соответствие ТЗ, равномерность распределения пользователей, регион регистрации пользователей)
3. Исследование данных о пользовательской активности
4. Исследовательский анализ данных (распределение и динамика событий, время проведения теста, воронка)
